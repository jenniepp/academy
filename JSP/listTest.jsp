...
<script type="text/javascript">
	 ...
	 function itemAdd(){
		 ...
		 var f=document.myForm; //myForm(); < 이거아님!!
		 var leftItem=f.leftItem;
		 
		 leftItem[0]=new Option('배수지','배수지');
		 leftItem[1]=new Option('유인나','유인나');
		 leftItem[2]=new Option('정인선','정인선');
		 leftItem[3]=new Option('박은빈','박은빈'); 
		 leftItem[4]=new Option('우영우','우영우'); 
		 leftItem[5]=new Option('강아랑','강아랑'); 
	 }
...
<tr align="center">
	<td width="150">
		<select name="leftItem" multiple="multiple" size="7" class="itemList"></select>
	</td>
	<td width="70">
...
<tr>
	...
	<input type="button" value="쪽지보내기" class="btn" onclick=""/><br/>
	</td>
</tr>
