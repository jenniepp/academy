...
<% 
	request.setCharacterEncoding("UTF-8");
 	String cp= request.getContextPath(); //위치정보가 나옴
%>
...
취미:<br/>
<select size="4" name="hobby" multiple="multiple">
...
동의하니까?<input type="checkbox" name="agreeChk" value="y"/><br/>
...
<input type="button" value="취소"
	onclick="javasript:location.href='<%=cp%>/index.jsp'"/>
