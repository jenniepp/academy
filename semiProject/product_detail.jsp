...
<head>
	...
	function sendCart(){
		...
		f.action="<%=cp%>/shopmoody1/cart_insert.do";
		f.submit();
...
<%-- 
	function detail_plus(){
		...
		f.action="<%=cp%>/shopmoody1/detail_plus.do";
		f.submit();
	
	}

	function detail_minus(){
	
		var f= document.myForm;
		
		f.action="<%=cp%>/shopmoody1/detail_minus.do";
		f.submit();
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class=""align="center">
                        ...
                        <div class=""  style="width: 400px; height: 600px">
                            <img class="w-100 h-100" src="${imagePath}/${prdto.imageFile}" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">${prdto.pname }</h3>
                ...
                <h3 class="font-weight-semi-bold mb-4"><fmt:formatNumber value="${prdto.price}" type="number"/> Won</h3>
               <!-- 여기 원래 폼위치 -->
                <div class="d-flex mb-3" >
                    <p class="text-dark font-weight-medium mb-0 mr-3">Sizes:</p>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="size-2" name="psize">
                            <label class="custom-control-label" for="size-2">S</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="size-3" name="psize">
                            <label class="custom-control-label" for="size-3">M</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="size-4" name="psize">
                ...
                <div class="d-flex align-items-center mb-4 pt-2" >
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        <div class="input-group-btn">
                              <button class="btn btn-sm btn-primary btn-minus" onclick="location='<%=cp%>/shopmoody1/cart_minus.do?num=${dto.num }&cnt=${cnt }';">
                              <i class="fa fa-minus"></i>
                              </button>
                        </div>
                              <input type="text" class="form-control form-control-sm bg-secondary text-center" value="${cnt }">
                               <div class="input-group-btn">
                                <button class="btn btn-sm btn-primary btn-plus" onclick="location='<%=cp%>/shopmoody1/cart_plus.do?num=${dto.num }&cnt=${cnt }';">
						...
						<input type = "button" name = "cnt" onclick = "sendCart();"/>
						<!-- <button type="summit" class="btn btn-primary px-3" >
            ...
            <div class="col">
                ...
                <div class="tab-content" align="center">
                    <div class="tab-pane fade show active" id="tab-pane-1">
                     ...
                     <img alt="" src="${imagePath}/${prdto.description}" >
