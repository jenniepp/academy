...
<tr height="30">
	...
	<%=dto.getHak() %>
	<!-- 테이블의 변수명과 태그의 name과 dto의 변수명이 동일하면 action에 의해서 데이터가 흐른다. -->
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="kor" value="<%=dto.getKor() %>"size="20" maxlength="10" class="txtField">
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="eng" value="<%=dto.getEng() %>"size="20" maxlength="10" class="txtField">
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="mat" value="<%=dto.getMat() %>"size="20" maxlength="10" class="txtField">
	</td>
</tr>
