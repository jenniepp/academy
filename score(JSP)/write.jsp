...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="kor" size="20" maxlength="10" class="txtField">
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="eng" size="20" maxlength="10" class="txtField">
	</td>
</tr>
...
<tr height="30">
	...
	<td style="padding-left: 5px;">
	<input type="text" name="mat" size="20" maxlength="10" class="txtField">
	</td>
</tr>
